module cam_modal_aero_coag

contains
! Lightly edited subroutines from modal_aero_coag.F90
!
...
! MW constants from shr_const_mod.F90 are instead hardcoded here

      real(r8) :: p0 = 101325.0 ! Pa
      real(r8) :: tmelt = 273.15  ! K
      real(r8) :: boltz = 1.38065e-23  ! J/K/molecule
...
end module cam_modal_aero_coag  
