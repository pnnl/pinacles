...
!  use grid, only: masterproc  temporarily commented
...
CONTAINS
  ...
  SUBROUTINE init_scavenging(masterproc)
    !
  ...
  SUBROUTINE m2011_scavenging(qna,qma,cmd, cmddry, sigma, &
    ...
    IF (lprint) THEN
        DO k = 186, 231
           print*, k, 'diam=', cmd(1,1,k,1), &
           'gamma=',g3d(1,1,k,1), g3d(1,1,k,2), g3d(1,1,k,3), g3d(1,1,k,4), g3d(1,1,k, 5), &
           'pflux=', pr_c(1,1,k), 'relhum=', rhw(1,1,k)
        ENDDO
    ENDIF
