...
f 
        ...
        v = profiles_grp.createVariable('thetali', np.double, dimensions=('time', 'z',))
        ...
        v = profiles_grp.createVariable('thetali2', np.double, dimensions=('time', 'z',))
        ...
        v = profiles_grp.createVariable('thetali3', np.double, dimensions=('time', 'z',))
        v.long_name = 'third central moment of liquid-ice potential temperature'
        v.latex_name = '\overline{\theta_{li}^\prime \theta_{li}^\prime \theta_{li}^\prime}'
        v.units = 'K^3'
        ...
        v = profiles_grp.createVariable('thetali4', np.double, dimensions=('time', 'z',))
        ...
        v = profiles_grp.createVariable('wthetali', np.double, dimensions=('time', 'z',))
        ...
        for var in self._ScalarState.names:
            if  not 'ff' in  var:  #Avoid SBM Bins
                v = profiles_grp.createVariable('w' + var, np.double, dimensions=('time', 'z',))
                v.long_name = 'resolved ' + self._ScalarState._long_names[var] + ' vertical flux'
                v.latex_name = '\overline{ w^\prime ' + self._ScalarState._latex_names[var] + '}'
                v.units = 'm s^-1 ' + self._ScalarState._units[var]

        v = profiles_grp.createVariable('qtthetali', np.double, dimensions=('time', 'z',))
