...
class GridBase:
    ...
    def _get_local_grid_indicies(self):
        ...
        # Get the local shape
        self._ngrid_local = tuple(self._local_shape + 2 * self._n_halo)
        self._local_shape = tuple(self._local_shape)
        self._local_start = tuple(self._local_start)
        self._local_end = tuple(self._local_end)
