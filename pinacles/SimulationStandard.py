...
class SimulationStandard(SimulationBase.SimulationBase):
    ...
    def initialize(self):
        ...
        self.Plumes = Plumes.Plumes(self._namelist, self.Timers,  self.ModelGrid, self.Ref, self.ScalarState, self.VelocityState, self.TimeSteppingController, self._nest_num)
