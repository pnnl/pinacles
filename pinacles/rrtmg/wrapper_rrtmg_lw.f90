...
contains
    ...
    subroutine c_rrtmg_lw &
        ...
        integer(c_int), intent(in), value :: icld         ! Cloud overlap method
                                                          ...
                                                          !    2: Maximum/random
                                                          !    3: Maximum
        integer(c_int), intent(in), value :: idrv            ! Flag for calculation of dFdT, the change
        ...
        integer(c_int), intent(in), value :: inflglw         ! Flag for cloud optical properties
        integer(c_int), intent(in), value :: iceflglw        ! Flag for ice particle specification
        integer(c_int), intent(in), value :: liqflglw        ! Flag for liquid droplet specification
    ...
    end module wrapper_rrtmg_lw
!     integer(c_int), intent(in), value :: arg_int1, arg_int2
!     real(c_double), intent(in), value :: arg_real1
!     real(c_double), intent(in) :: arg_array1(arg_int1:arg_int2)

!     write(*,*) arg_int1
!     write(*,*) arg_int2
!     write(*,*) arg_real1
!     write(*,*) arg_array1(arg_int1), arg_array1(arg_int2)
!     end subroutine c_rrtmg_lw
! end module wrapper_rrtmg
