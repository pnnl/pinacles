...
class P3:
    def __init__(self):
        ...
        self.ffi.cdef(
            "void c_p3_init(char dir_path_c[], int dir_path_len, int nCat, \
        ...
        self.ffi.cdef(
            "void c_p3_main(int ids, int ide, int jds, int jde, int kds, int kde, \
        ...
        self.ffi.cdef(
            "void c_p3_main_1mom(int ids, int ide, int jds, int jde, int kds, int kde, \
            int ims, int ime, int jms, int jme, int kms, int kme, \
            int its, int ite, int jts, int jte, int kts, int kte, \
            double th_3d[], double qv_3d[], double qc_3d[], double qr_3d[], \
            double qnr_3d[], double diag_zdbz_3d[], double diag_effc_3d[], \
    ...
    def init(
        ...
        path = str(os.path.join(os.getcwd(), "pinacles_data_dependencies/P3"))

        if not os.path.exists(path):
            # This supports running this file as main
            path = "../../pinacles_data_dependencies/P3"

        path = path.encode("ascii")

        self._lib_p3.c_p3_init(
