...
class BoundaryBrinkman:
    ...
    @staticmethod
    @numba.njit()
    def _compute_masks(terrain_fraction, x_edge_mask, y_edge_mask, z_edge_mask, cc_mask):
        shape = terrain_fraction.shape
    ...
    @staticmethod
    @numba.njit()
    def _compute_dists(x_edge_mask, y_edge_mask, z_edge_mask, cc_mask, x_mask_dist, y_mask_dist, z_mask_dist, cc_mask_dist):
    ...
    def initialize(self):
        ...
        self._compute_masks(terrain_fraction, x_edge_mask, y_edge_mask, z_edge_mask, cc_mask)
        self._compute_dists(x_edge_mask, y_edge_mask, z_edge_mask, cc_mask, x_mask_dist, y_mask_dist, z_mask_dist, cc_mask_dist)
