...
class MomentumWENO5(MomentumAdvectionBase):
    ...
    def update(self):
        ...
        #U Component
        MomentumAdvection_impl.u_advection_4th(rho0, rho0_edge,
        ...
        #V Component
        MomentumAdvection_impl.v_advection_4th(rho0, rho0_edge,
            u, v, w, fluxx, fluxy, fluxz)
        ...
        # W Component
        MomentumAdvection_impl.w_advection_4th(rho0, rho0_edge
            ,u, v, w, fluxx, fluxy, fluxz)
