...
subroutine c_rrtmg_sw &
    ...
    integer(c_int), intent(in),value :: ncol            ! Number of horizontal columns     
    integer(c_int), intent(in), value :: nlay            ! Number of model layers
    integer(c_int), intent(in), value :: icld         ! Cloud overlap method
                                                      !    0: Clear only
                                                      !    1: Random
                                                      !    2: Maximum/random
                                                      !    3: Maximum
    integer(c_int), intent(in),value :: iaer         ! Aerosol option flag
                                                      !    0: No aerosol
                                                      !    6: ECMWF method
    ...
    integer(c_int), intent(in), value :: dyofyr          ! Day of the year (used to get Earth/Sun
                                                      !  distance if adjflx not provided)
    real(c_double), intent(in), value :: adjes              ! Flux adjustment for Earth/Sun distance
    real(c_double), intent(in) :: coszen(ncol)          ! Cosine of solar zenith angle
                                                      !    Dimensions: (ncol)
    real(c_double), intent(in), value :: scon               ! Solar constant (W/m2)

    integer(c_int), intent(in), value :: inflgsw         ! Flag for cloud optical properties
    integer(c_int), intent(in), value :: iceflgsw        ! Flag for ice particle specification
    integer(c_int), intent(in), value :: liqflgsw        ! Flag for liquid droplet specification
