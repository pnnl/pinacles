...
class SurfaceRICO(Surface.SurfaceBase):
    ...
    def update(self):
        ...
        Surface_impl.iles_surface_flux_application(50.0, z_edge, dxi2, nh, alpha0, alpha0_edge, 500, self._taux_sfc, ut)
        Surface_impl.iles_surface_flux_application(50.0, z_edge, dxi2, nh, alpha0, alpha0_edge, 500, self._tauy_sfc, vt)
        Surface_impl.iles_surface_flux_application(50.0, z_edge, dxi2, nh, alpha0, alpha0_edge, 500, shf, st)
        Surface_impl.iles_surface_flux_application(50.0, z_edge, dxi2, nh, alpha0, alpha0_edge, 500, qv_flx_sfc , qvt)
