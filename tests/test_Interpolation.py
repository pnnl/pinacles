...
def test_interp_second():
    ...
    for n in [33, 65, 129, 257, 513, 1025]:
        ...
        for xi in x:
            ...
            fit.append(
                interpolation_impl.centered_second(f(-0.5 * dx + xi), f(0.5 * dx + xi))
            )
...
def test_interp_sixth():
    ...
    for n in [33, 65, 129, 257, 513, 1025]:
        ...
        for xi in x:
            ...
            fit.append(
                interpolation_impl.centered_sixth(
                    f(-2.5 * dx + xi),
                    f(-1.5 * dx + xi),
                    f(-0.5 * dx + xi),
                    f(0.5 * dx + xi),
...
def test_interp_weno5_z():

    interp_val = interpolation_impl.interp_weno5_z(0.0, 1.0, 2.0, 3.0, 4.0)
    # assert(2.5 == interp_val)
