...
def main(namelist):
    ...
    u_slice = SimulationUtilities.HorizontalSlice(
        "u_80m", height=80, frequency=5.0, var="u", state="VelocityState", Sim=Sim
    )
    v_slice = SimulationUtilities.HorizontalSlice(
        "v_80m", height=80, frequency=5.0, var="v", state="VelocityState", Sim=Sim
    )
    eddy_viscosity = SimulationUtilities.HorizontalSlice(
        "vt_80m",
        height=80,
        frequency=5.0,
        var="eddy_diffusivity",
